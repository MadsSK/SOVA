...
namespace DataAccessLayerUnitTestProject
{
    ...
    public class MySqlRepositoryQuestionTest
    {
        ...
        {
            Assert.That(_repository.GetAllQuestions().Count().Equals(1620));
        }

        [Test]
        public void GetQuestionTest()
        {
            Assert.That(_repository.GetQuestion(19).Equals(
                new
                {
                    Id = 19,
