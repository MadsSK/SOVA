...
namespace DataAccessLayerUnitTestProject
{
    ...
    public class MySqlRepositoryPostTest
    {
        ...
        {
            Assert.That(_repository.GetPost(19).Id.Equals(19));
        }

        [Test]
        public void GetPostCreationDateTest()
        {
            Assert.That(_repository.GetPost(19).CreationDate.Equals(
        ...
        {
            Assert.That(_repository.GetPost(19).Score.Equals(164));
        }
        ...
        {
            Assert.That(_repository.GetPost(19).OwnerUserId.Equals(13));
        }

        [Test]
        public void GetPostTest()
        {
            Assert.That(_repository.GetPost(19).Equals(
                new
                {
                    Id = 19,
