...
namespace DataAccessLayerUnitTestProject
{
    ...
    public class MySqlRepositoryPostTest
    {
        ...
        {
            Assert.That(_repository.FindPost(19).Id.Equals(19));
        }

        [Test]
        public void FindPostCreationDateTest()
        {
            Assert.That(_repository.FindPost(19).CreationDate.Equals(
                new DateTime(2008, 08, 01, 05, 21, 22)));
        }

        [Test]
        public void FindPostScoreTest()
        {
            Assert.That(_repository.FindPost(19).Score.Equals(164));
        }

        [Test]
        public void FindPostBodyTest()
        {
            Assert.That(
                _repository.FindPost(19)
                    .Body.Equals(
        ...
        [Test]
        public void FindPostOwnerUserIdTest()
        {
            Assert.That(_repository.FindPost(19).OwnerUserId.Equals(13));
        }

        [Test]
        public void FindPostTest()
        {
            Assert.That(_repository.FindPost(19).Equals(
                new
                {
                    Id = 19,
